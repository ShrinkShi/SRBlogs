...
<template>
  <div class="mt-8 flex flex-wrap gap-3 border-t border-white/10 pt-5">
    ...
    <a class="rounded-2xl bg-white/10 px-4 py-2 text-sm text-white/80 hover:bg-white/[0.15]" :href="`https://twitter.com/intent/tweet?url=${encodeURIComponent(currentHref)}`" target="_blank">分享到 X</a>
  </div>
</template>
