...
<template>
  <div
    ...
    @focusout="hideSoon"
  >
    <button ref="buttonRef" type="button" class="icon-button h-9 w-9" :aria-label="player.muted ? '取消静音' : '静音'" @click="player.toggleMuted()">
    ...
    <Teleport to="body">
      <div
        v-if="open"
        class="volume-slider-panel volume-slider-panel-floating"
