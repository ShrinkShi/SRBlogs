...
const author = () => props.settings?.author || props.settings?.authorName || 'SRBlogs'
const description = () => props.settings?.description || props.settings?.bio || '在代码、文字与生活碎片之间，搭建一座轻量而漂亮的个人博客。'
