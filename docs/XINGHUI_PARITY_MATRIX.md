...
2026-05-03 P1/P2 混合收口轮后：

- `P0`：约 100%。内容读取/写入、登录鉴权、公开草稿保护、评论、媒体管理、设置边界、安全写入、审计日志、备份恢复、构建运行和 Secret 扫描均已通过验证；真实服务器部署实操单独标记为待执行。
- `P1`：约 99%。搜索、标签、归档、SEO/RSS/Sitemap、后台写作、草稿、pendingOperations 第一阶段、设置中心表单化、错误状态、操作反馈、真实使用手册和发布准备均已收口；GitHub OAuth 评论真实授权仍需配置后人工验收。
- `P2`：约 88%。已完成铺满式顶部导航、滚动隐藏/显示、首页“名片 + 紧凑音乐播放器 + 歌词区 + 不对称内容模块 + 底部状态区”、主题 token、后台控制台视觉、Toast、全局音乐、相册组编辑、Markdown 拖动分栏等；仍需浏览器人工回归后继续推进。
