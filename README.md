...
> 当前进度：P0 100%，P1 100%，P2 约 84%。本轮完成顶层 Toast、后台设置轻量分区、结构化内容弹窗、近全屏 Markdown 编辑器、Markdown 快捷工具栏、点击音效、上传分档限制和冗余播放器清理。

> 当前进度：P0 100%，P1 100%，P2 约 80%。本轮修复后台 Markdown 动态导入回归，首页进入“文章轮播 + 照片轮播 + 更新轮播 + 独立昼夜切换卡片”的目标结构，后台导航改为垂直父子目录，并增强本地图片/音频/视频上传。
