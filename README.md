...
- 设置中心剩余项已完成 API/构建级验收：空 Secret 保留、评论开关、图床 local 上传、AI 设置边界和部署文档核验均已通过；真实 OSS/Gitalk/AI 联调仍不属于当前 P0/P1 收口范围。
- 后台写作、草稿和暂存队列已完成自动/API 收口验证，等待最终人工验收后再在矩阵中标记完成。
