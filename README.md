...
- 后台文章编辑：展示 v1.3.0 双栏编辑器、Markdown 工具栏和预览。
...
│   ├── app/version.py        # v1.3.0 统一版本与 GitHub 仓库常量
...
- README 暂未包含 v1.3.0 截图，发布 GitHub Release 前建议补充前台、后台编辑器、评论弹窗和在线安装 TUI 截图。
