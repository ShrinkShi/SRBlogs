...
COMPONENT_THEME_LABELS: dict[str, str] = {
    ...
    "homePhotoCarousel": "首页相册轮播",
    "homeUpdatesCarousel": "首页更新内容轮播",
    "homeThemeToggle": "首页旧版主题卡片",
...
def public_settings(data: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "siteDescription": data.get("siteDescription") or data.get("description") or "",
        ...
        "bio": data.get("bio", ""),
        "profileIntro": data.get("profileIntro") or data.get("bio", ""),
        "icp": data.get("icp") or data.get("beian", ""),
        "beian": data.get("beian") or data.get("icp", ""),
