...
<template>
  <form class="glass w-full max-w-md rounded-[32px] p-8" @submit.prevent="submit">
    ...
    <div class="mt-7 grid gap-4">
      <input v-model="form.username" class="rounded-2xl border border-white/10 bg-white/10 px-4 py-3 outline-none focus:border-cyan-300/60" placeholder="用户名" />
      <input v-model="form.password" type="password" class="rounded-2xl border border-white/10 bg-white/10 px-4 py-3 outline-none focus:border-cyan-300/60" placeholder="密码" />
